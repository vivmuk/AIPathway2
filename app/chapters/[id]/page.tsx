      ...
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="card mb-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-800">Latest on the Topic</h2>
          </div>
          ...
          {chapterData.updatesSummary ? (
            ...
            <div className="bg-slate-50 border-l-4 border-slate-300 p-4 mb-6 rounded-r-lg">
              <p className="text-slate-600 text-sm">
                Summarizing the latest research, updates, and GenAI applications related to this topic...
              </p>
            </div>
          )}
          ...
          {chapterData.latestNews && chapterData.latestNews.length > 0 ? (
            ...
            <div className="bg-slate-50 rounded-lg p-6 text-center border border-slate-200">
              <p className="text-slate-600">
                No recent updates found. This section will show the latest research, tools, and GenAI applications as they become available.
              </p>
            </div>
          )}
        </div>
